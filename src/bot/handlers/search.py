...
def show_paginated_place(message, bot, index=0):
    ...
    name = place.get('name', utils.t(profile, 'Nomsiz', 'Без названия'))
    ...
    if len(description) > available_length_for_desc:
        truncated_description = description[:available_length_for_desc] + "..."
